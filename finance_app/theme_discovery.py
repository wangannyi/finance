PROACTIVE_THEMES = {
    ...
    "ch": [
        ...
        {
            "name": "电子特气/六氟化钨",
            "keywords": ["电子特气", "特种气体", "六氟化钨", "WF6", "三氟化氮", "刻蚀气", "含氟类特种气体"],
            "risk": "涨价和国产替代预期已被快速交易，需警惕订单不确定和高位波动。",
        },
        {
            "name": "光刻胶/湿电子化学品",
            "keywords": ["光刻胶", "KrF", "ArF", "湿电子化学品", "显影液", "清洗剂", "剥离液"],
            "risk": "客户验证周期长，量产进度和盈利弹性需要持续核验。",
        },
        {
            "name": "刻蚀材料/设备",
            "keywords": ["刻蚀", "刻蚀设备", "刻蚀材料", "蚀刻液", "介质刻蚀", "等离子刻蚀"],
            "risk": "设备和材料验证壁垒高，短期涨幅可能领先基本面兑现。",
        },
        {
            "name": "氟化工/含氟电子材料",
            "keywords": ["氟化工", "含氟材料", "含氟电子材料", "含氟电子特气", "电子化学品", "氟碳", "氟聚合物", "PTFE", "六氟丁二烯", "高端氟材料"],
            "risk": "商品价格、环保供给和半导体需求都会影响景气持续性。",
        },
        {
            "name": "靶材/溅射材料",
            "keywords": ["靶材", "溅射靶材", "铜靶", "铝靶", "钽靶", "半导体材料"],
            "risk": "国产替代节奏和客户认证决定中期空间，短线容易受情绪影响。",
        },
        {
            "name": "半导体硅片",
            "keywords": ["半导体硅片", "先进硅片", "大硅片", "硅片", "外延片"],
            "risk": "硅片仍有周期属性，价格和产能利用率需要同步验证。",
        },
    ],
    "hk": [
        {
